...
openai.api_key = "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"
...
WANDB_PROJECT_NAME = "gpt-prompt-eng"  # used if you use_wandb is True, Weights &| Biases project name
WANDB_RUN_NAME = None  # used if you use_wandb is True, optionally set the Weights & Biases run name to identify this run
